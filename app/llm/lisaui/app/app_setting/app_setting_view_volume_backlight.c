...
#ifdef __ZEPHYR__
INCBIN(icon_back_png, "app_ui/aweui/assets/png/back_png.png");
...
#else
INCBIN(icon_back_png, "app/awe/aweui/assets/png/back_png.png");
...
static const lv_font_t *font_normal;S
...
lv_obj_t *_lisaui_app_view_create_volume_backlight(lv_obj_t *parent)
{
    ...
    lv_slider_set_range(uiAppSetting_SliderBacklight, UI_SILDER_BACKLIGHT_BRIGHTNESS_MIN_VALUE,
                        UI_SILDER_BACKLIGHT_BRIGHTNESS_MAX_VALUE);
	...
	// extern uint8_t aweui_read_brightness(void);
	// brightness_value = aweui_read_brightness();
