...
lv_obj_t * ui_ScreenApp_ScanOCR_BtnStart;
lv_obj_t * ui_ScreenApp_ScanOCR_BtnStop;
...
void ui_event_OpenApp(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        ...
        case APP_ID_OCR:
            ...
            lv_obj_set_style_text_font(ui_ScreenApp_ScanOCR_LabResult, &lv_font_chinese_18, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_StatusBar_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_pos(ui_StatusBar_BtnBackHome, 0, -10);
...
void ui_Screen_AppOCR_init(void)
{
    ...
    lv_obj_set_size(ui_ScreenApp_ScanOCR_LabResult, 280, 130);
    lv_obj_set_pos(ui_ScreenApp_ScanOCR_LabResult, 20, 20);
    lv_obj_set_align(ui_ScreenApp_ScanOCR_LabResult, LV_ALIGN_LEFT_MID);
    lv_obj_set_style_text_font(ui_ScreenApp_ScanOCR_LabResult, &lv_font_chinese_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_textarea_set_placeholder_text(ui_ScreenApp_ScanOCR_LabResult, "支持更大容量的高速和片外，支持用户配置数据缓存与指令缓存。带宽；其低功耗蓝牙子系统支持可通过与广播扩展实现远距离通信。它还支持 2 Mbps PHY，用于提高传输速度和数据吞吐量。ESP32-S3 的 Wi-Fi 和 Bluetooth LE 射频性能优越，在高温下也能稳定工作。.");
    // lv_textarea_set_placeholder_text(ui_ScreenApp_ScanOCR_LabResult, "量金野支持更大容量的");
    ...
    lv_obj_set_style_bg_color(ui_ScreenApp_ScanOCR_LabResult, lv_color_hex(0x202020), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_ScreenApp_ScanOCR_BtnStart = lv_btn_create(ui_ScreenApp_ScanOCR_Body);
    lv_obj_set_size(ui_ScreenApp_ScanOCR_BtnStart, 120, 100);
    lv_obj_set_pos(ui_ScreenApp_ScanOCR_BtnStart, 0, 0);
    lv_obj_set_align(ui_ScreenApp_ScanOCR_BtnStart, LV_ALIGN_RIGHT_MID);
    lv_obj_add_flag(ui_ScreenApp_ScanOCR_BtnStart, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_ScreenApp_ScanOCR_BtnStart, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    
    lv_obj_t * ui_BtnTranslate = lv_label_create(ui_ScreenApp_ScanOCR_BtnStart);
    ...
    lv_obj_add_event_cb(ui_ScreenApp_ScanOCR_BtnStart, ui_event_BtnTranslateAction, LV_EVENT_CLICKED, NULL);
}
...
void ui_Screen_AppAudioPlayer_init(void)
{
    ...
    lv_obj_set_pos(ui_ScreenApp_AudioPlayer_BtnStart, 100,10);
    lv_obj_set_align(ui_ScreenApp_AudioPlayer_BtnStart, LV_ALIGN_CENTER);
    ...
    lv_obj_set_pos(ui_ScreenApp_AudioPlayer_BtnStop, -100,10);
    lv_obj_set_align(ui_ScreenApp_AudioPlayer_BtnStop, LV_ALIGN_CENTER);
...
void ui_Screen_AppWsp_init(void)
{
    ...
    lv_obj_set_size(ui_ScreenApp_Wsp_BtnStart, 120, 50);
    lv_obj_set_pos(ui_ScreenApp_Wsp_BtnStart, -20, -10);
    lv_obj_set_align(ui_ScreenApp_Wsp_BtnStart, LV_ALIGN_RIGHT_MID);
    ...
    lv_obj_set_size(ui_ScreenApp_Wsp_BtnStop, 120, 50);
    lv_obj_set_pos(ui_ScreenApp_Wsp_BtnStop, -20, 50);
    lv_obj_set_align(ui_ScreenApp_Wsp_BtnStop, LV_ALIGN_RIGHT_MID);
    ...
    lv_obj_set_size(ui_ScreenApp_Wsp_Result, 280, 120);
    lv_obj_set_pos(ui_ScreenApp_Wsp_Result, 20, 20);
    lv_obj_set_align(ui_ScreenApp_Wsp_Result, LV_ALIGN_LEFT_MID);
...
void ui_Screen_AppSetting_init(void)
{
    ...
    lv_obj_set_style_text_font(ui_ScreenApp_Setting_LabelBacklight, &lv_font_chinese_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_ScreenApp_Setting_LabelVolume, &lv_font_chinese_18, LV_PART_MAIN | LV_STATE_DEFAULT);
