 ...
 *  STATIC PROTOTYPES
 **********************/
static void physic_engine_create(lv_obj_t *parent);
...
static void physic_engine_create(lv_obj_t *parent)
{
    ...
    lv_obj_t *circle_ball = lv_led_create(parent);
    lv_led_off(circle_ball);
    lv_obj_set_size(circle_ball, 90, 90);
    lv_obj_align_to(circle_ball, parent, LV_ALIGN_RIGHT_MID, 0, 0);
