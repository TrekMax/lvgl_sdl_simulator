...
lisaui_err_t app_setting_create(void *parent)
{
    ...
    uiAppSetting_LabelBacklight = lv_label_create(g_app_setting);
    ...
    uiAppSetting_SliderBacklight = lv_slider_create(g_app_setting);
    ...
    uiAppSetting_LabelVolume = lv_label_create(g_app_setting);
    ...
    uiAppSetting_SliderVolume = lv_slider_create(g_app_setting);
