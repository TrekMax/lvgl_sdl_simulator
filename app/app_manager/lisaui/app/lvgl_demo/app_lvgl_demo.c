...
lisaui_err_t LISAUI_DEFINE_APP_FUNC(lvgl_demo, enter, void, { return LISAUI_ERR_OK; });
lisaui_err_t LISAUI_DEFINE_APP_FUNC(lvgl_demo, exit, void, { return LISAUI_ERR_OK; });
void *LISAUI_DEFINE_APP_FUNC(lvgl_demo, get_page, void, { return g_app_lvgl_demo; });
